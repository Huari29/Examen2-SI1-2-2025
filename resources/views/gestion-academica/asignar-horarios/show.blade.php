        ...
        <div class="p-6 max-w-3xl mx-auto">
            ...
            <form action="{{ route('detalle-horario.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="id_materia" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
                ...
                <div>
                    ...
                    <select name="id_grupo" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
                ...
                <div>
                    ...
                    <select name="id_docente" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
                ...
                <div>
                    ...
                    <select name="id_aula" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
                        <option value="">Seleccione aula</option>
                        @foreach ($aulas as $aula)
                            <option value="{{ $aula->id_aula }}">{{ $aula->nombre }} (Capacidad:
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach (['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'] as $dia)
                            <label
                                class="flex items-center space-x-2 cursor-pointer bg-neutral-800 px-4 py-2 rounded-full hover:bg-neutral-700 transition">
                ...
                {{-- Horario --}}
                <div>
                    <label class="block font-medium text-neutral-100">Horario</label>
                    <select name="id_horario" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
                ...
                <div>
                    ...
                    <select name="gestion" class="w-full border rounded-lg px-3 py-2 bg-neutral-900 text-neutral-100"
                        required>
