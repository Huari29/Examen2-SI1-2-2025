...
class AulaController extends Controller
{
    ...
    {
        $aulas = Aula::all();
        return view('gestion-academica.aulas.index', compact('aulas'));
    }

    public function create()
    {
        return view('gestion-academica.aulas.create');
    }
    ...
    {
        return view('gestion-academica.aulas.edit', compact('aula'));
    }
